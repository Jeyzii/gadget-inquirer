<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formP.aspx.cs" Inherits="webProg6Ils.formP" %>
...
<!--Navigation bar -->
        <div class="navbar">
            ...
            <a href="formP.aspx" class="active">Peripherals</a
        </div>
        <br />
        <br />
        <br />
                ...
                <tr>
                    <td>
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT DISTINCT [Product_Brand] FROM [tbl_Gadget] WHERE (([Product_Category] = @Product_Category) AND ([Product_Status] = @Product_Status))">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="GridView1" DefaultValue="peripheral" Name="Product_Category" PropertyName="SelectedValue" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tbl_Gadget] WHERE (([Product_Brand] = @Product_Brand) AND ([Product_Category] = @Product_Category) AND ([Product_Status] = @Product_Status))">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="DropDownList1" Name="Product_Brand" PropertyName="SelectedValue" Type="String" />
                                <asp:ControlParameter ControlID="GridView1" DefaultValue="Peripheral" Name="Product_Category" PropertyName="SelectedValue" Type="String" />
                                <asp:ControlParameter ControlID="GridView1" DefaultValue="AVAILABLE" Name="Product_Status" PropertyName="SelectedValue" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tbl_Gadget] WHERE (([Product_Status] = @Product_Status) AND ([Product_Category] = @Product_Category))">
                            <SelectParameters>
                                ...
                                <asp:ControlParameter ControlID="GridView2" DefaultValue="Peripheral" Name="Product_Category" PropertyName="SelectedValue" Type="String" />
                            </SelectParameters>
                        </asp:SqlDataSource>
                    </td>
                </tr>
