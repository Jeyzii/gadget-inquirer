<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formUserKB.aspx.cs" Inherits="webProg6Ils.formUserKB" %>
...
<body>
    ...
    <div class="navbar">
        ...
        <a href="formUserKB.aspx"  class="active">Keyboard</a>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td>
                    <asp:GridView ID="GridView1" cssClass="grivdiew"  EmptyDataText="No records Found" runat="server" ForeColor="White" Width="100%" AutoGenerateColumns="False" DataKeyNames="Id" GridLines="Horizontal" AllowPaging="True" DataSourceID="SqlDataSource1" Visible="False">
                        <Columns>
                ...
                <PagerStyle BackColor="Black" Height="15px" HorizontalAlign="Center" />
                        ...
                        <asp:GridView ID="GridView2" cssClass="grivdiew"  EmptyDataText="No records Found" runat="server" ForeColor="White" Width="100%" AutoGenerateColumns="False" DataKeyNames="Id" GridLines="Horizontal" AllowPaging="True" DataSourceID="SqlDataSource2">
                        <Columns>
                            <asp:ImageField DataImageUrlField="img_Path" HeaderText="Image" SortExpression="img_Path" />
                            <asp:BoundField DataField="Product_Name" HeaderText="Name" SortExpression="Product_Name" />
                            <asp:BoundField DataField="Product_Price" HeaderText="Price(PhP)" SortExpression="Product_Price" />
                ...
                <tr>
                    <td>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tbl_Gadget] WHERE (([Product_Category] = @Product_Category) AND ([Product_Brand] = @Product_Brand) AND ([Product_Status] = @Product_Status))">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="GridView1" DefaultValue="KEYBOARD" Name="Product_Category" PropertyName="SelectedValue" Type="String" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tbl_Gadget] WHERE (([Product_Category] = @Product_Category) AND ([Product_Status] = @Product_Status))">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="GridView2" DefaultValue="KEYBOARD" Name="Product_Category" PropertyName="SelectedValue" Type="String" />
