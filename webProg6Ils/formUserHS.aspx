<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formUserHS.aspx.cs" Inherits="webProg6Ils.formUserHS" %>
...
<body>
    ...
    <div class="navbar">
        ...
        <a href="formUserHS.aspx"  class="active">Headset</a>
                        ...
                        <tr>
                            <td>
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tbl_Gadget] WHERE (([Product_Category] = @Product_Category) AND ([Product_Status] = @Product_Status))">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="GridView2" DefaultValue="Headset" Name="Product_Category" PropertyName="SelectedValue" Type="String" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [tbl_Gadget] WHERE (([Product_Category] = @Product_Category) AND ([Product_Status] = @Product_Status) AND ([Product_Brand] = @Product_Brand))">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="GridView1" DefaultValue="Headset" Name="Product_Category" PropertyName="SelectedValue" Type="String" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Product_Brand] FROM [tbl_Gadget] WHERE (([Product_Category] = @Product_Category) AND ([Product_Status] = @Product_Status))">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="GridView1" DefaultValue="Headset" Name="Product_Category" PropertyName="SelectedValue" Type="String" />
                                        <asp:ControlParameter ControlID="GridView1" DefaultValue="AVAILABLE" Name="Product_Status" PropertyName="SelectedValue" Type="String" />
                                    </SelectParameters>
